...
Gives lobster.cash agents access to <!-- br:models.chatVisible -->76<!-- /br:models.chatVisible --> AI models and image generation via [BlockRun](https://sol.blockrun.ai). Payment handled by the lobster.cash smart wallet via x402.
