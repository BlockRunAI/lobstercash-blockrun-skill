...
Access 40+ AI models and image generation via [BlockRun](https://sol.blockrun.ai). No API keys needed — payment is handled automatically by lobster.cash via x402.
