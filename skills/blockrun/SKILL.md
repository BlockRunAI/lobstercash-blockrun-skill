...
Access <!-- br:models.chatVisible -->79<!-- /br:models.chatVisible --> AI models and image generation via [BlockRun](https://sol.blockrun.ai). Use a BlockRun account API key, or pay through the lobster.cash Solana wallet via x402.
